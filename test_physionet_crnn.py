...
if __name__ == "__main__":
    ...
    if is_debug:
        ...
        writer = SummaryWriter('/nethome/shong375/log/crnn1d/challenge2017/new')

    # make data
    # preprocess_physionet() ## run this if you have no preprocessed data yet
    X_train, X_test, Y_train, Y_test, pid_test = read_data_physionet_2(window_size=3000, stride=500)
